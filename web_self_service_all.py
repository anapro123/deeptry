"""
ARBITRAGE BOT WITH ALL OPPORTUNITIES SHOWN
No limit - shows every opportunity found!
"""
...
DEFAULT_CONFIG = {
    ...
    'SCAN_INTERVAL': 5,
    'MAX_OPPORTUNITIES_DISPLAY': 50,  # Show up to 50 opportunities
...
# ============================================
# EXCHANGE APIS (Keep your existing working ones)
# ============================================
...
# HTML Template - Shows ALL opportunities
MAIN_TEMPLATE = '''
<!DOCTYPE html>
<html>
<head>
    <title>🚀 Arbitrage Bot - All Opportunities</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 ARBITRAGE BOT</h1>
            <div class="subtitle">All live opportunities - Updated every 10 seconds</div>
        </div>
...
async def main():
    ...
    print("\n" + "="*70)
    print("🚀 ARBITRAGE BOT - ALL OPPORTUNITIES SHOWN")
    print("="*70)
    print("📊 Exchanges: Binance, Bybit, OKX, KuCoin, Kraken, Gate.io")
    print("📈 Shows ALL opportunities (no limit)")

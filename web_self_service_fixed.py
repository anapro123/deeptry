"""
ARBITRAGE BOT WITH SELF-SERVICE USER REGISTRATION - FIXED VERSION
"""
...
# ============================================
# SYNC VERSION OF SEND TELEGRAM (for Flask)
# ============================================
...
def register():
    ...
    # Send welcome message (synchronous)
    welcome_msg = f"""
🎉 <b>Welcome {name}!</b>
...
Stay tuned for opportunities! 🚀
    ...
    # Send in background using threading
...
async def main():
    ...
    print("\n" + "="*70)
    print("🚀 ARBITRAGE BOT - SELF-SERVICE USER REGISTRATION (FIXED)")
    print("="*70)
    ...
    try:
        ...
        print("📦 Installing requests for Telegram messages...")
        import subprocess

"""
ARBITRAGE BOT - COMPLETE WITH CHAT ID GUIDE
Includes instructions for users to get their Telegram Chat ID
"""
...
class ArbitrageEngine:
    ...
    async def scan(self):
        ...
        for opp in self.opportunities[:5]:
            if opp['profit_usd'] > 0.01:
                is_new = True
                for prev in self.previous_opportunities[:5]:
        ...
        if self.scan_count % 5 == 0:
            print(f"📊 Scan {self.scan_count}: Found {len(self.opportunities)} valid opportunities")
        
        return self.opportunities

# ============================================
# FLASK WEB APP WITH CHAT ID GUIDE
# ============================================
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header .filter-info { color: #666; font-size: 0.8em; margin-top: 5px; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 ARBITRAGE BOT</h1>
            <div class="subtitle">Real-time arbitrage scanning across 6 exchanges</div>
            <div class="filter-info">
                <span class="filter-badge">✅ Max ROI: {{ config.MAX_PROFIT_PERCENT }}%</span>
                <span class="filter-badge">🎯 Min Spread: {{ config.MIN_PROFIT_PERCENT }}%</span>
                <span class="filter-badge">💰 Min Profit: ${{ config.MIN_PROFIT_USD }}</span>
                <span class="filter-badge">👥 Users: {{ config.TELEGRAM.users|length }}</span>
            </div>
        </div>
...
async def main():
    ...
    print("="*70)
    print("🚀 ARBITRAGE BOT - COMPLETE WITH CHAT ID GUIDE")
    print("="*70)
    print("📊 Exchanges: Binance, Bybit, OKX, KuCoin, Kraken, Gate.io")
    print("🛡️  Filtering: Max ROI 50%")
    print("📱 Chat ID Guide: Built into web interface")

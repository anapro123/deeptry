"""
ARBITRAGE BOT - REAL-TIME UPDATES
...
# ============================================
# ARBITRAGE ENGINE WITH REAL-TIME UPDATES
# ============================================
...
class ArbitrageEngine:
    ...
    async def scan(self):
        ...
        if self.opportunities:
            self.last_opportunity_time = self.opportunities[0]['timestamp']
...
# ============================================
# FLASK WEB APP - REAL-TIME UPDATES
# ============================================

app = Flask(__name__)
engine = ArbitrageEngine()

# Global variable to store latest data for SSE
latest_data = {
    'opportunities': [],
    'stats': {},
    'timestamp': ''
...
def update_latest_data():
    """Update the global latest_data with current engine data"""
    global latest_data
    latest_data['opportunities'] = engine.opportunities[:20]
...
<html>
<head>
    <title>🚀 Arbitrage Bot - Real-Time</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @keyframes flashGreen {
            0% { background: #00ff00; color: #0a0a0a; }
            100% { background: transparent; color: #00ff00; }
        }
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 ARBITRAGE BOT</h1>
            <div class="subtitle">Real-time updates - No refresh needed!</div>
            <div class="live-status">🔴 LIVE - Updates every 5 seconds</div>
            <div class="update-time" id="updateTime">Last update: Waiting...</div>
        </div>
        ...
        <div class="section">
            ...
            <div class="exchange-status-grid" id="exchangeStatus">
    ...
    <script>
        ...
        function updateUI(data) {
            // Update time
            document.getElementById('updateTime').textContent = 'Last update: ' + data.timestamp;
            ...
            if (data.opportunities && data.opportunities.length > 0) {
                ...
                container.innerHTML = '<p style="color: #888; text-align: center; padding: 20px;">🔍 No opportunities found. Scanning...</p>';
            }
            ...
            if (data.stats && data.stats.exchanges_status) {
                ...
                for (const [name, status] of Object.entries(data.stats.exchanges_status)) {
                    ...
                    html += `<div class="exchange-status">
                        ...
                        <div class="status">
                            <span class="${isOnline ? 'status-online' : 'status-offline'}">${status}</span>
                        </div>
                        <div class="pairs">${pairs} pairs</div>
                    </div>`;
                }
...
def api_opportunities():
    update_latest_data()
    return jsonify(latest_data['opportunities'])
...
async def background_scanner():
    print("🔄 Scanner started - REAL-TIME UPDATES")
...
async def main():
    ...
    print("="*70)
    print("🚀 ARBITRAGE BOT - REAL-TIME UPDATES")
    print("="*70)
    print("📊 Exchanges: Binance, Bybit, OKX, KuCoin, Kraken, Gate.io")
    print("📤 Alerts: EVERY opportunity found")
    print("🌐 Web: http://localhost:5000")
    print("📡 REAL-TIME: No refresh needed - updates push automatically!")
    print("="*70 + "\n")
